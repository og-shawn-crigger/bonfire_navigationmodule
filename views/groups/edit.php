...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="<?php echo lang('bf_action_save');?>" /> or <?php echo anchor(SITE_AREA.'/content/navigation/groups', lang('navigation_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA.'/content/navigation/groups/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('navigation_delete_confirm'); ?>')"><?php echo lang('navigation_delete_record'); ?></a>
